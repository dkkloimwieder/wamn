...
DO $$ DECLARE tbls text; BEGIN
  ...
  ASSERT tbls = 'identity.password_attempts,identity.password_credentials,identity.password_tokens,identity.pats,identity.principals,identity.project_env_memberships,identity.project_roles,identity.session_keys,identity.session_signing_state,provisioning.sagas,registry.env_policies,registry.event_readers,registry.meta,registry.orgs,registry.project_envs,registry.projects,registry.retired_project_envs',
