...
//! Owns: scheduled/event entry completion, caller-release and fail lifecycle
//! state; the ported-edge walk, branch/merge, error-path routing;
...
pub use engine::{
    ...
    snapshot, validate_request_outcome,
};
