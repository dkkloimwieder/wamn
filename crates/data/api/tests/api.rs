...
use wamn_schema_model::{Cardinality, Catalog, Entity, Field, FieldType, Relation};

const POC: &str = include_str!("../../../schema/model/tests/fixtures/poc-receiving.catalog.json");
