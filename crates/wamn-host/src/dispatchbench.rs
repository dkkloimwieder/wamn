...
//! [`crate::dispatch::Dispatcher`] engine with **stepped time** — the trigger
...
use crate::dispatch::{Dispatcher, DispatcherConfig, ProjectSpec};
...
async fn wake_phase(
    ...
    let early = d.tick_project(0, crate::dispatch::epoch_ms()).await?;
    ...
    let due = d.tick_project(0, crate::dispatch::epoch_ms()).await?;
    ...
    let fired_tick = d.tick_project(0, crate::dispatch::epoch_ms()).await?;
