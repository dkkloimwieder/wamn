...
pub use manifest::{
    ...
    BaseDependencyRequirement, CdcDisposition, ClaimDeclaration, ClientPackage,
    CommandCanonicalization, CommandIdempotence, CommandLineOrder, CommandTransaction,
    ...
    EventRegistrationDeclaration, FieldText, FilterDeclaration, InheritedClaimDeclaration,
