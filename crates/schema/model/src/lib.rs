...
//!   published at `docs/reference/contracts/catalog-model.schema.json` (drift-guarded by a test).
...
/// source of truth). Serialized to `docs/reference/contracts/catalog-model.schema.json`; a drift
