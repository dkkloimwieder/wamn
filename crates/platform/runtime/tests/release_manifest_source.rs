...
fn pulled_bytes_load_the_release_naming_their_carrier() {
    let canonical = br#"{"attachments":{},"components":[],"format-version":3,"release":{"effective-release-id":7,"environment":"prod","packages":[{"package-id":"cat","package-version":"1.0.0"}],"tenant-id":"t1"},"routes":[]}"#;
