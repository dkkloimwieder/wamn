...
//! (allowlist v1, docs/archive/execution/wamn-node-design-notes.md §9), and anything else is
//! refused — most load-bearingly `wamn:postgres` (the raw DB surface + the
//! `DO`/`EXECUTE` claim-mutation bypass, docs/archive/findings.md §3 E17) and
...
/// TENANT artifact may import (docs/archive/execution/wamn-node-design-notes.md §9, the 5.4
...
//      (docs/archive/execution/wamn-node-design-notes.md note 7).

/// Within the `wamn:node` package a custom node may import ONLY these
/// interfaces (5.5 interface-level tightening; the frozen `docs/archive/contracts/wamn-node.wit`
...
mod tests {
    ...
    /// A standard http-node world (`docs/archive/contracts/wamn-node.wit`) clears the interface
