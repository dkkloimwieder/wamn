...
//! variant (`docs/archive/contracts/wamn-node.wit`), the same way `wamn_api::SqlValue` mirrors
...
//! (`docs/archive/execution/wamn-node-design-notes.md` §6). `wamn-runner` re-exports these types,
