...
| `QueryTable` | The `DataTable` of one generated read, wired from its table definition alone: the load, the scope filters, the sort, the record labels, the row buttons, the inline edit and the child tables |
