...
cases = {'executor-surface': ('WAMN_EXEC_PLATFORM_PG_URL', ['cargo', '+1.98.0', 'test', '--locked', '--offline', '-p', 'wamn-runtime', '--test', 'executor_platform_surface_live', '--', '--ignored', '--nocapture'])}
if len(sys.argv) > 1:
    case = sys.argv[1]
    key, argv = cases[case]
