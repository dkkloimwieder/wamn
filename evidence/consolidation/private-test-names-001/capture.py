...
out = Path('/home/kaalin/dev/wamn/evidence/consolidation/private-test-names-001')
out.mkdir(parents=True, exist_ok=False)
paths = ['crates/execution/host/src/router_driver/native_policy/tests.rs', 'services/scenario-worker/tests/management_live.rs', 'tests/integration/src/trusted_http_route.rs']
...
commands = [
    ['cargo', '+1.98.0', 'test', '--locked', '--offline', '-p', 'wamn-execution-host', '--lib', 'router_driver::native_policy::tests::', '--', '--nocapture', '--test-threads=1'],
    ['cargo', '+1.98.0', 'test', '--locked', '--offline', '-p', 'wamn-scenario-worker', '--test', 'management_live', '--no-run'],
    ['cargo', '+1.98.0', 'test', '--locked', '--offline', '-p', 'wamn-integration-tests', '--lib', '--no-run'],
]
results = []
