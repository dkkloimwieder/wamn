...
assert head=='4dbe6222d9cfd2301960204622e471cf36401b5c',head
...
cases=[
 ('runtime',common+['-p','wamn-runtime','--features','wasm_component_model_implements,wash-runtime/washlet,wash-runtime/wasi-config,wash-runtime/wasi-otel,wash-runtime/wasmcloud-nats','--lib','--','--nocapture','plugins::effect_span::tests::','plugins::connection_http::tests::','plugins::wamn_blobstore::plugin::tests::','component_admission::tests::operation_dependencies_refuse_missing_extra_and_mismatch']),
 ('conformance',common+['-p','wamn-conformance-tests','--test','state_ownership','--test','contract_diff','--test','kind_gate_image_remove','--test','gate_registry','--','--nocapture']),
 ('deadline',common+['-p','wamn-system-tests','--lib','deadline_test::','--','--nocapture']),
]
