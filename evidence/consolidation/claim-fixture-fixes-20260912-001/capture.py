...
source = '68c3cc4519eac38aa5c3b98fe710d72038d11501'
cases = {
    'production-claim-001': ('WAMN_PRODUCTION_CLAIM_PG_URL', 'production_claim_live'),
    'production-claim-durable-001': ('WAMN_DURABLE_TIER_PG_URL', 'production_claim_durable_live'),
}
