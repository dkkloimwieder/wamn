...
out = Path('/home/kaalin/dev/wamn/evidence/consolidation/native-ack-names-001')
out.mkdir(parents=True, exist_ok=False)
paths = ['services/cdc-reader/src/lib.rs', 'tests/integration/src/trusted_http_route.rs']
...
commands = [
    ['cargo', '+1.98.0', 'test', '--locked', '--offline', '-p', 'wamn-cdc-reader', '--lib', '--', '--nocapture', '--test-threads=1'],
    ['cargo', '+1.98.0', 'test', '--locked', '--offline', '-p', 'wamn-integration-tests', '--lib', 'trusted_http_route::tests::', '--', '--nocapture', '--test-threads=1'],
]
results = []
