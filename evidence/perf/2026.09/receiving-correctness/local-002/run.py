#!/usr/bin/env python3
"""Capture the Receiving proof compile after the UUID evidence correction."""
import datetime
import hashlib
import json
import os
...
with (evidence / 'cargo.log').open('xb') as log:
