...
The [build guide](../../../../docs/operations/build-and-test.md) retains the separate guest digest defect under `wamn-10yt.61`.
...
Their [recipe and scope](../../../../docs/operations/build-and-test.md#receiving-cluster-journey--released-flow-http-scheduling-and-reachability) require a new clean-source run. None records a live pass yet.
