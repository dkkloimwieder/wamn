...
wamn_evidence=/home/kaalin/dev/wamn/docs/perf/2026.09/wasmcloud-2-9-cutover/live-wms-001
...
printf '%s\n' 'tools/wms-cluster-journey-run --apply --evidence-dir /home/kaalin/dev/wamn/docs/perf/2026.09/wasmcloud-2-9-cutover/live-wms-001/journey' > "$wamn_evidence/command.txt"
tools/wms-cluster-journey-run --apply --evidence-dir "$wamn_evidence/journey" > "$wamn_evidence/journey.log" 2>&1
wamn_status=$?
