...
wamn_evidence=docs/perf/2026.09/wasmcloud-2-9-cutover/build-002
date -u +%FT%TZ > "$wamn_evidence/started.txt"
cargo metadata --offline --format-version 1 > "$wamn_evidence/metadata.json" 2> "$wamn_evidence/metadata.log"
