...
expected_head = 'd09e9c571378c75bd2fdf4fe2efdcade64af7a12'
...
selections = [
    ...
    ('integration-publication', ['-p', 'wamn-proof-integration', '--lib', 'publication']),
    ('integration-wms-wiring', ['-p', 'wamn-proof-integration', '--lib', 'wms_wiring_shape']),
    ('integration-wms-runtime', ['-p', 'wamn-proof-integration', '--lib', 'wms_runtime_live']),
]
...
results = []
try:
    with tempfile.TemporaryDirectory(prefix='wamn-operator-selection-') as scratch:
        env['TMPDIR'] = scratch
