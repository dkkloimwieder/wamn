...
commands = [
    ["cargo", "+1.98.0", "test", "--locked", "--offline", "-p", "wamn-schema-generator", "--test", "generation", "--test", "parity", "--", "--nocapture"],
    ["cargo", "+1.98.0", "test", "--locked", "--offline", "-p", "wamn-schema-generator", "--lib", "materialize::tests::", "--", "--nocapture"],
    ["cargo", "+1.98.0", "test", "--locked", "--offline", "-p", "wamn-receiving-tests", "--test", "generation", "--", "--nocapture"],
    ["cargo", "+1.98.0", "build", "--locked", "--offline", "-p", "wamn-schema-generator", "--example", "materialize_package"],
]
def git(*args):
