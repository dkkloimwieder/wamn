...
The accepted contract is [Increment 2](../../../../docs/poc/wamn_testing_spec.md).
The application defines `OVL-SCHEMA`, `REC-EVENT-REPLAY`, and `REC-POSTCOMMIT-PROGRESS` in its [scenario](../../../../docs/poc/wamn_receiving_layered_application_poc_scenario.md).
