...
mod client_acme_native {
    ...
    pub mod receiving_record_receipt_participant {
        include!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../apps/client_acme_receiving/generated/native-verifier/receiving_record_receipt_participant.rs"
        ));
    }
}
...
fn client_acme_native_verifier_compiles_the_exact_runtime_sql_files() {
    ...
    let _ = sqlx::query_file_as!(
        client_acme_native::receiving_record_receipt_participant::RecordReceiptParticipantRow,
        "../../../apps/client_acme_receiving/command/record_receipt_participant/record_receipt_participant.sql",
        client_acme_native::receiving_record_receipt_participant::record_receipt_participant_receipt_id_bind_fixture(),
        client_acme_native::receiving_record_receipt_participant::record_receipt_participant_purchase_order_id_bind_fixture()
    );
}
