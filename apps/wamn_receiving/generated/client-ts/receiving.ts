...
export const RECEIVING_LOAD_RECEIPT_SCREEN_ROUTE: OperationRoute = {
  ...
  contract: {
    ...
    errors: [
      { literal: "internal_error", required: [], sources: ["query_error", "row_limit_exceeded", "undeclared_constraint"], text: null },
      { literal: "invalid_input", required: ["field"], sources: ["malformed_input"], text: null },
      { literal: "not_found", required: ["field", "id"], sources: ["transaction_invariant"], text: null },
      { literal: "permission_denied", required: ["operation"], sources: ["permission_denied"], text: null },
      { literal: "retry", required: [], sources: ["connection_unavailable", "serialization_failure"], text: null },
      { literal: "timeout", required: [], sources: ["statement_timeout"], text: null },
    ],
...
export const RECEIVING_RECORD_RECEIPT_ROUTE: OperationRoute = {
  ...
  contract: {
    ...
    errors: [
      ...
      { literal: "permission_denied", required: ["operation"], sources: ["permission_denied"], text: null },
      { literal: "purchase_order_line_mismatch", required: ["field", "id"], sources: ["transaction_invariant"], text: null },
      { literal: "purchase_order_line_not_found", required: ["field", "id"], sources: ["transaction_invariant"], text: null },
      { literal: "purchase_order_not_found", required: ["field"], sources: ["transaction_invariant"], text: null },
      { literal: "purchase_order_not_open", required: ["field"], sources: ["transaction_invariant"], text: "This purchase order is not open, so it takes no receipt." },
      { literal: "quantity_exceeds_remaining", required: ["field", "id"], sources: ["transaction_invariant"], text: null },
      { literal: "receipt_reference_conflict", required: ["constraint"], sources: ["unique_violation"], text: null },
      { literal: "retry", required: [], sources: ["connection_unavailable", "serialization_failure"], text: null },
      { literal: "timeout", required: [], sources: ["statement_timeout"], text: null },
    ],
    replay: "claim",
