...
pub(crate) const APPLY_SQL: &str = include_str!("../../command/inventory_merge/apply.sql");
pub(crate) const CLAIM_COMMAND_SQL: &str =
    include_str!("../../command/inventory_merge/claim_command.sql");
pub(crate) const CLOSE_SOURCE_SQL: &str =
    include_str!("../../command/inventory_merge/close_source.sql");
...
pub(crate) const LOCK_INVENTORY_SQL: &str =
    include_str!("../../command/inventory_merge/lock_inventory.sql");
pub(crate) const LOCK_PACKAGING_SQL: &str =
    include_str!("../../command/inventory_merge/lock_packaging.sql");
...
pub(crate) fn close_source_inventory_id_bind_fixture() -> uuid::Uuid {
    uuid::Uuid::nil()
}
...
pub(crate) fn lock_inventory_from_inventory_id_bind_fixture() -> uuid::Uuid {
    uuid::Uuid::nil()
}
pub(crate) fn lock_inventory_to_inventory_id_bind_fixture() -> uuid::Uuid {
    uuid::Uuid::nil()
}
