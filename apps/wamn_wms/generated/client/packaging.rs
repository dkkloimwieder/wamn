...
#[derive(Debug, Clone, PartialEq)]
pub struct PackagingRelocateRequest {
    /// `text`
    pub request_id: String,
    /// `object`
    pub value: PackagingRelocateRequestValue,
}

#[derive(Debug, Clone, PartialEq)]
pub struct PackagingRelocateRequestValue {
    /// `int32`
    pub expected_row_version: i32,
    /// `text`
    pub idempotency_key: String,
...
#[derive(Debug, Clone, PartialEq)]
pub struct PackagingRelocateResult {
    /// `text`
    pub code: String,
    /// `text`
    pub lifecycle: String,
...
/// Input descriptors for `wamn-wms:packaging/relocate@1.0.0`.
pub const PACKAGING_RELOCATE_INPUT: &[FieldDescriptor] = &[
    FieldDescriptor {
        path: "request_id",
        type_name: "text",
        nullable: false,
...
/// Result descriptors for `wamn-wms:packaging/relocate@1.0.0`.
pub const PACKAGING_RELOCATE_RESULT: &[FieldDescriptor] = &[
    FieldDescriptor {
        path: "code",
        type_name: "text",
        nullable: false,
...
pub const PACKAGING_RELOCATE_INPUT_SCHEMA: &[wamn_client::descriptor::FieldSchema] = &[
    wamn_client::descriptor::FieldSchema {
        field: FieldDescriptor {
            path: "request_id",
            type_name: "text",
...
pub const PACKAGING_RELOCATE_RESULT_SCHEMA: &[wamn_client::descriptor::FieldSchema] = &[
    wamn_client::descriptor::FieldSchema {
        field: FieldDescriptor {
            path: "code",
            type_name: "text",
...
pub const PACKAGING_RELOCATE_KIND: &str = "command";
pub const PACKAGING_RELOCATE_REQUIRES_COMPOSITION: bool = true;
pub const PACKAGING_RELOCATE_REPLAY: Option<&str> = Some("claim");
pub const PACKAGING_RELOCATE_RESPONSE_CONTRACT: Option<&str> = Some("{\"type\":\"array\"}");
pub const PACKAGING_RELOCATE_RESULT_OPAQUE: bool = false;
/// The grant a caller presents to invoke `wamn-wms:packaging/relocate@1.0.0`.
pub const PACKAGING_RELOCATE_GRANT: &str = "wamn-wms:packaging/relocate@1.0.0";

/// Typed refusals `wamn-wms:packaging/relocate@1.0.0` declares.
pub const PACKAGING_RELOCATE_ERRORS: &[&str] = &[
    "concurrency_conflict",
    "idempotency_conflict",
    "internal_error",
    "invalid_input",
...
/// deployment config, not this release's facts.
#[must_use]
pub fn relocate_route() -> RouteMetadata {
    RouteMetadata {
        method: "POST".to_owned(),
        template: "/packaging/relocate".to_owned(),
    }
}

/// Invoke `wamn-wms:packaging/relocate@1.0.0` through a bound client.
///
/// # Errors
///
/// [`ClientError`] for a transport failure, a refusal, or a response that
...
pub async fn relocate(
    ...
    client
        .invoke(&relocate_route(), &std::collections::BTreeMap::new(), items)
        .await
}
