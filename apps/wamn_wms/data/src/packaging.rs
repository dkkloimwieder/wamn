//! `packaging` get and query over the generated statements.

use wamn_postgres_statements::Connection;

use crate::error::{self, AccessError, AccessErrorKind};
use crate::generated::wamn::packaging as sql;
use crate::page::{self, Page};
use crate::scalar;

pub use crate::generated::wamn::packaging::PackagingRow;

/// Load one packaging by id.
///
/// # Errors
///
/// [`AccessError`] carrying the literal the operation contract declares.
pub async fn get(connection: &mut Connection, id: &str) -> Result<PackagingRow, AccessError> {
...
pub async fn query(
    ...
    cursor: Option<&str>,
    limit: Option<i64>,
) -> Result<Page<PackagingRow>, AccessError> {
