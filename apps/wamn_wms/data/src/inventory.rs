//! `inventory` get and query over the generated statements.

use wamn_postgres_statements::Connection;

use crate::error::{self, AccessError, AccessErrorKind};
use crate::generated::wamn::inventory as sql;
use crate::page::{self, Page};
use crate::scalar;

pub use crate::generated::wamn::inventory::InventoryRow;
...
pub async fn get(connection: &mut Connection, id: &str) -> Result<InventoryRow, AccessError> {
...
pub async fn query(
    ...
    cursor: Option<&str>,
    limit: Option<i64>,
) -> Result<Page<InventoryRow>, AccessError> {
