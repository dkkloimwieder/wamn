//! `inventory_transaction` get and query over the generated statements.

use wamn_postgres_statements::Connection;

use crate::error::{self, AccessError, AccessErrorKind};
use crate::generated::wamn::inventory_transaction as sql;
use crate::page::{self, Page};
use crate::scalar;

pub use crate::generated::wamn::inventory_transaction::InventoryTransactionRow;

/// Load one inventory_transaction by id.
///
/// # Errors
///
...
pub async fn get(
    ...
    id: &str,
) -> Result<InventoryTransactionRow, AccessError> {
...
pub async fn query(
    ...
    cursor: Option<&str>,
    limit: Option<i64>,
) -> Result<Page<InventoryTransactionRow>, AccessError> {
