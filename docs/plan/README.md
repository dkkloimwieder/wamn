...
- [Control library split](ctl-split-plan.md): Remaining control verbs, delivery code, and ops verbs to move from `services/ctl` into `wamn-control`, and the later dev loop separation.
