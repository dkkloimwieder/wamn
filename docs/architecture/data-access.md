...
The [statement check test](../../crates/schema/generator/tests/statement_check_live.rs) adds a `to_jsonb` read of `receipt_line` to a copy of Receiving, and the check refuses it.
