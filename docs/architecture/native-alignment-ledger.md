...
Planned substitutions: see [plan §3](../history/wamn_native_alignment_plan.md#3-recommended-changes).
...
The [cutover charter](../history/wamn_wasmcloud_2_9_cutover.md) governs those later stages.
The [cutover report](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/report.md) records evidence and limitations.
...
The [descriptor proof](../../evidence/perf/2026.09/native-a-descriptor/report.md), owned by `wamn-0ct2.1`, records four passing subprocess cases.
...
The [native dispatch checkpoint](../../evidence/perf/2026.09/native-b-dispatch/report.md) belongs to `wamn-0ct2.2`.
...
The owner decision of 2026-09-10 supersedes that contract through [B's admission boundary](../history/wamn_native_alignment_plan.md#b-replace-manual-guest-execution-including-its-duplicate-caches).
...
The [production report](../../evidence/perf/2026.09/native-b-adoption/production-report.md) retains the failed attempts and the corrected six-scenario trace proof.
...
The [main authenticated proof](../../evidence/perf/2026.09/native-b-adoption/production-authenticated-main-001/output.log) passes all six scenarios, including exact trace parentage.
The [deployed Receiving proof](../../evidence/perf/2026.09/native-b-adoption/production-receiving-002/receiving-correctness-journey.receipt) passes at that source with 19 histories, 129 steps, and seven boundaries.
...
The earlier [native NATS checkpoint](../../evidence/perf/2026.09/native-c-nats/report.md), owned by `wamn-0ct2.4`, records the private native message-handle boundary.
...
The reviewed [C source checkpoint of 2026-09-11](../../evidence/perf/2026.09/native-c-advisories/source-checkpoint-001/handoff.json) under `wamn-0ct2.7` supersedes those implementation alternatives.
...
The [scoped native run](../../evidence/perf/2026.09/native-c-advisories/scoped-native-004/README.md) demonstrates the allowed operations and actual broker refusals across three environments.
The [retained native run](../../evidence/perf/2026.09/native-c-advisories/retained-native-001/README.md) demonstrates advisory retention, later delivery progress, deleted payload reporting, and deduplication.
...
The [P3 HTTP cutover](../../evidence/perf/2026.09/p3-http-cutover/report.md) belongs to `wamn-0h0g.2.7.17`.
...
The [combined Cargo check](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/build-003/exit-code.txt) passed with `--workspace --all-targets --locked`.
The host and executor binary builds, both standalone probe checks, and three [chart argument checks](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-001/host-arguments.json) also pass.
The argument checks deliberately refuse startup after parsing and load no secret environment.

The [upstream gate](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/upstream-gate-003/results.json) passes all six legs with upstream default features, separately from WAMN production features.
...
The earlier [workspace sweep](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-001/workspace-results.json) exits 101 with 2,114 reported test passes, six doctest passes, and 67 failures across 32 targets.
...
Workspace [Clippy](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-002/exit-code.txt) exits 0 with warnings.
After two lifecycle lint cleanups, all four [focused lifecycle tests](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-003/lifecycle-tests.log) pass.
The [scoped runtime Clippy](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-003/runtime-clippy-exit-code.txt) also exits 0 with warnings.
The final lifecycle module emits neither of its two corrected warnings.
The first [full Receiving journey](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-001/journey/verdict.json) passes at clean `7798190c`, covering the released application, materializer, native scheduling, and cleanup.
Current [telemetry](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-003/journey/telemetry/receipt.json) passes at `a40d1c18`.
The complete [startup receipt](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-004/journey/startup-burst/result.json) passes at `802aed06`, with eight overlapping native handlers per cold and warm herd.
...
The [fifth run](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-005/journey/operator-recovery/installed-crd-identity.json) passes all five installed CRD identities and the pinned operator image.
...
The [sixth-run diagnosis](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/operator-timeout-diagnosis-001/diagnosis.json) identifies a liveness HTTP timeout that triggers a graceful operator restart before NATS returns.
...
The later [ninth run](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-009/journey/operator-recovery/result.json) completes scheduler recovery and deliberate operator replacement.
It records no natural operator restart. The failed runs remain failed, and the underlying HTTP delay remains unproved.

The first armed [authority run](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/authority-live-001/summary.json) records 40 passes and three failures across 43 tests.
...
The [fresh-server rerun](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/authority-inventory-live-001/summary.json) passes all 24 tenant-floor and denial-matrix tests at clean `379faef6`, with no skips and successful cleanup.
The [protected-write capture](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/authority-inventory-live-001/event-registration-protected-write-capture.json) confirms guest SELECT, no non-owner table or column writes, and forced row security.
...
The [full WMS journey](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-wms-001/journey/journey.receipt) passes at clean `ab0467f4`.
...
The separate [startup run](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-wms-startup-002/journey/runtime-startup.receipt) passes at clean `6bfda73b`, with cold/restart startup times of 12,561/623 ms and four unchanged cache files.
One [steady request ratio](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-wms-startup-002/journey/overhead-ratio-steady.receipt) is 7.022 against the unchanged ceiling of 12.
The [restart probe](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-wms-startup-002/journey/first-request-restart-first.receipt) reaches exact 200 after seven HTTP 503 responses and 27 transport failures.
...
The [memory evidence map](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/memory-cancellation-map-001/evidence-map.json) records executed accounting, limit, cancellation, trap, nested-call, and epoch proofs.
That historical proof uses two manual stores whose growth calls run in sequence.
The later [deadline proof](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/memory-cancellation-map-001/deadline-refund-execution.json) observes two charged guest pages, native epoch interruption, zero usage after store removal, and fresh allocation.
...
Both exact [virtualization tests](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/virtualization-live-003/summary.json) pass at clean `d45a0fe9`, without skips.
...
The final [real host test](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/workspace-sweep-final-001/workspace.log) passes in 69.63 seconds at clean `c6808b12`.
...
The [host Clippy receipt](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/host-lifecycle-clippy-final-001/summary.json) exits 0 on unchanged clean source, with existing warnings.

A separate [native first-beat case](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/workspace-sweep-final-001/host-lifecycle/native-missing-first-beat.receipt) exercises ClusterHost and WAMN lifecycle helpers inside the test process.
...
A later [host test](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/probe-listener-lifecycle-001/summary.json) proves actual native probe termination through the production error translation and cleanup.
...
Its [tests pass](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-001/workspace-sweep.log) for bind/unbind transitions, refusals, application responses, and the missing-handle residual.
...
The [distributed-chart render](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/deployment-001/observations.json) passed for default, Receiving, and WMS profiles.
...
The render and [public operator image metadata](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/deployment-001/distributed-image.json) prove configuration and distributed artifact identity only.
...
The [eighth run](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-008/exit-code.txt) passes sampler startup and reaches the scheduler NATS outage.
After an accepted graceful restart, the never-ready operator replacement exits 1 with an initial NATS dial timeout.
The [native source/log record](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/operator-startup-refusal-001/source-map.json) preserves this refusal without claiming its concrete Go error type.
Host identities persist and cleanup passes. This eighth run remains failed.
The [ninth full journey](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-009/journey/verdict.json) passes at clean `38318082`, including both recovery phases and owned cleanup.
The [repeated performance comparison](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/performance-comparison-001/tables.md) is complete. It does not establish a general improvement.
...
The [distributed CRD capture](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/deployment-crds-001/crd-inventory.json) confirms that all five 2.9 schema files match the pinned source.
...
The earlier [source capture](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/validation-004/source-inputs.json) precedes that commit.
The [previous final workspace sweep](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/workspace-sweep-final-001/workspace-results.json) completes at clean `c6808b12` in 264.834 seconds and exits 101.
...
The [source receipt](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/workspace-sweep-final-001/source-stability.json) confirms unchanged clean source before and after the run.
The [2.8 performance baseline](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/performance-baseline-evidence-001/evidence-map.json) passes 108 steps with a service ratio median of 10.1408 against 12.
...
The [correction replay](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/receiving-probe-scheme-fix-001/receipt.json) passes and preserves every probe refusal.
The [second candidate run](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/performance-2-9-002/exit-code.txt) passes at clean `e7033f72`, with 108 completed steps and a service ratio median of 8.8608 against 12.
The [completion receipt](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/performance-completion-002/state.json) confirms both measured source revisions remain clean afterward.
...
The [candidate map](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/performance-candidate-evidence-001/evidence-map.json) retains exact image identities and the missing operator Pod imageID receipt.
...
The [ninth-run result](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-009/journey/operator-recovery/result.json) preserves all three Host objects and processes through a 154.9018-second scheduler outage.
...
The [integration workspace check](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/workspace-integration-001/workspace-results.json) completes at clean `38318082` in 163.036 seconds and exits 101.
...
The [source receipt](../../evidence/perf/2026.09/wasmcloud-2-9-cutover/workspace-integration-001/source-stability.json) confirms clean, unchanged source. The parent bead `wamn-0h0g.2.7` records main integration and the shared-file fence.
