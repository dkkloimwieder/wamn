...
- Catalog model (the promotion format): `docs/schema/catalog-model.md`, `crates/schema/model`.
- DDL compiler (reused for the migration): `docs/schema/ddl-compiler.md`, `crates/schema/compiler`.
