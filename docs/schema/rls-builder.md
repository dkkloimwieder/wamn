...
- Tenant floor (what these compose on): `docs/schema/ddl-compiler.md`, `crates/schema/compiler`.
- Claim injection: `docs/contracts/wamn-postgres.wit`, the wamn:postgres plugin (2.2 / 4.2).
