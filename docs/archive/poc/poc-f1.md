...
F1 is the synchronous request flow defined by `docs/archive/poc/POC-PLAN.md` r6 and
`docs/archive/execution/FLOW-SPEC.md` rev18. The former embedded `poc-webhook-f1` executor was
...
The package and exact-image recipes are in `docs/archive/build-and-test.md` under
