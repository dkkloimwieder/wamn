...
model (`docs/archive/poc/poc-material-receiving.md` §"Data model"), no UI — the P1 half of
...
- POC spec: `docs/archive/poc/poc-material-receiving.md` (§Data model, traceability matrix).
- The tools: `docs/archive/schema/migration-engine.md` (2.5), `docs/archive/schema/rls-builder.md` (3.5),
  `docs/archive/schema/seed-data.md` (3.6), `docs/archive/schema/app-schema.md` (2.4).
