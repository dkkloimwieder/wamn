...
**r6, 2026-07-26, against `docs/archive/execution/FLOW-SPEC.md` rev 18 and `main` @ `9ddcd7d`.**
...
`docs/archive/poc/poc-f1.md`'s contrary expectation and its stale task references are
