...
(`docs/archive/schema/ddl-compiler.md`).
...
- Plan: `docs/archive/platform-plan.md` §Epic 3 (3.5), §Epic 8 (8.2 tenant isolation).
- Catalog model (the input): `docs/archive/schema/catalog-model.md`, `crates/schema/model`.
- Tenant floor (what these compose on): `docs/archive/schema/ddl-compiler.md`, `crates/schema/compiler`.
- Claim injection: `docs/archive/contracts/wamn-postgres.wit`, the wamn:postgres plugin (2.2 / 4.2).
