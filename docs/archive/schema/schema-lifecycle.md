...
- [`wamn-control-registry`](../platform/registry-model.md) (`wamn-q3n.1`) — the control-plane
...
- Plan: `docs/archive/platform-plan.md` §Epic 3 (3.4).
- Catalog model (the promotion format): `docs/archive/schema/catalog-model.md`, `crates/schema/model`.
- DDL compiler (reused for the migration): `docs/archive/schema/ddl-compiler.md`, `crates/schema/compiler`.
