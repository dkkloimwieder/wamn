...
- **Contract file:** [`catalog-model.schema.json`](../contracts/catalog-model.schema.json) —
...
- Plan: `docs/archive/platform-plan.md` §Epic 3 (3.1–3.5), D14 (neutral core catalog).
- POC data model: `docs/archive/poc/poc-material-receiving.md` (Data model, traceability).
- Flow schema (the sibling contract crate): `docs/archive/execution/flow-schema.md`.
