...
fork ledger. Decision-table row **D17** added to `docs/archive/platform-plan.md` (wamn-8df.1, 2026-07-16).
...
`docs/archive/platform/wash-runtime-fork.md`. Policy (dkk, 2026-07-16): **do not spend effort
