...
- Plan: `docs/archive/platform-plan.md` §Epic 4 (4.1), §POC (POC-F1).
- Catalog model (routes/columns/types): `docs/archive/schema/catalog-model.md`, `crates/schema/model`.
- Tenant floor (the target tables): `docs/archive/schema/ddl-compiler.md`, `crates/schema/compiler`.
- Data path: `docs/archive/contracts/wamn-postgres.wit`, the S2/2.2 plugin.
