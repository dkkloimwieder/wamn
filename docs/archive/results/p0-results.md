...
`docs/archive/platform/wash-runtime-fork.md`)*: `scripts/vendor-wasmcloud.sh` cloned the pinned
...
the minimal `wamn:node` contract (docs/archive/contracts/wamn-node.wit) —
...
retained. (docs/archive/execution/wamn-node-design-notes.md note 9b updated.)
