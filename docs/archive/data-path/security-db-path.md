...
- **Plan:** `docs/archive/platform-plan.md` item 2.6 (and 8.2 tenant isolation)
...
`docs/archive/build-and-test.md`. The runtime gate and publish gate remain independent:
