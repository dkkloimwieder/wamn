...
- Catalog model (routes/columns/types): `docs/schema/catalog-model.md`, `crates/schema/model`.
- Tenant floor (the target tables): `docs/schema/ddl-compiler.md`, `crates/schema/compiler`.
- Data path: `docs/contracts/wamn-postgres.wit`, the S2/2.2 plugin.
