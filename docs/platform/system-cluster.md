...
rationale is `docs/platform/postgres-topology.md` §T1 (the source of truth).
...
- **`.3`** (**shipped**) — the system-DB registry **tables/DDL**
  ...
  `docs/platform/registry-model.md` §Storage schema documents what `.3` fills it with.
...
- Design: `docs/platform/postgres-topology.md` (§T1, §"The four tiers").
- The registry model this cluster will hold: `docs/platform/registry-model.md`
