...
It is the foundation of the Postgres topology (`docs/platform/postgres-topology.md`,
...
generic deployment model** (`docs/platform/deployment-model.md`): `env` is a validated
...
`docs/platform/deployment-model.md`.
...
- Topology: `docs/platform/postgres-topology.md` (§T1, §Environments, §Reversibility).
