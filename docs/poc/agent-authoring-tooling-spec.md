...
| F14 | Claim law: idempotent replay returns the immutable original result; a changed request under the same key typed-refuses. Every create-shaped command carries the two cases as `generated/contracts/<model>/create.claim-tests.json`, emitted by the generator. Executing them needs a live database, which is `wamn-f89v`. | `docs/poc/wamn_wms_application_poc_scenario.md:198-209`, `crates/schema/generator/src/generate.rs`, bead `wamn-10yt.19` |
