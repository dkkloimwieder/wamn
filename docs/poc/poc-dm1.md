...
model (`docs/poc/poc-material-receiving.md` §"Data model"), no UI — the P1 half of
...
- POC spec: `docs/poc/poc-material-receiving.md` (§Data model, traceability matrix).
- The tools: `docs/schema/migration-engine.md` (2.5), `docs/schema/rls-builder.md` (3.5),
  `docs/schema/seed-data.md` (3.6), `docs/schema/app-schema.md` (2.4).
