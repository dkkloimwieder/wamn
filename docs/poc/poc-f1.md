...
F1 is the synchronous request flow defined by `docs/poc/POC-PLAN.md` r6 and
`docs/execution/FLOW-SPEC.md` rev18. The former embedded `poc-webhook-f1` executor was
