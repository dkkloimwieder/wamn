...
- The plan model (the input): `docs/schema/ddl-compiler.md`, `crates/schema/compiler`.
- The registration edge: `crates/events/registration`, `docs/build-and-test.md` [EVT-REG/D24].
- The suite storage: `docs/testing/scenario-catalog.md`, `deploy/sql/flow-tests.sql`.
