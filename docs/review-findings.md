...
| R9b | Table rename × row-event registration — silent trigger loss | **Medium — silent breakage** | Re-homed 2026-07-18 (D19 v3): the residual closes at wamn-l5i9.11 (EVT-OIDMAP — OID→entity-id keying at CDC decode); the 11.8 impact-analysis case stands |
