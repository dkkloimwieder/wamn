...
The [eight-invariant brief](../../../poc/wamn_receiving_layered_application_poc_scenario.md#15-receiving-correctness-amendment-2026-09-09) maps the application rules to their state, enforcers, and proof cases.
The [build guide](../../../operations/build-and-test.md) contains the `RECEIVING-CORRECTNESS` recipe.
