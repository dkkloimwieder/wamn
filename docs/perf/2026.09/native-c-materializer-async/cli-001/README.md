...
All four inspection commands exited 0, with [WIT](after-wit.stdout) exporting `wasi:cli/run@0.3.0` as `run: async func() -> result` and [WAT](after-print.stdout) line 209469 showing its async canonical lift and callback.
