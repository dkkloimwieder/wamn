...
def main():
    ...
    driver_path = tree / "docs/perf/2026.09/generated-tui-wms/tools/wms_pty.py"
    spec = importlib.util.spec_from_file_location("wms_live_driver", driver_path)
    driver = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(driver)
    partial_path = tree / "docs/perf/2026.09/effects-response/live-002/journey/wms-partial-http.json"
