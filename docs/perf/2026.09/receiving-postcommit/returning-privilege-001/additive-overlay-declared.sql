...
PREPARE probe(uuid, bigint, boolean, boolean, boolean, text) AS
...
updated AS (
    ...
    RETURNING model.acme_inspection_required, model.acme_quality_status, model.created_at, model.id, model.purchase_order_number, model.row_version, model.status, model.supplier_id, model.updated_at
)
SELECT
    CASE
...
EXECUTE probe('00000000-0000-0000-0000-000000000301', 1, true, true, false, NULL);
ROLLBACK;
