...
wamn_evidence=/home/kaalin/dev/wamn/docs/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-004
...
printf '%s\n' 'tools/receiving-cluster-journey-run --apply --evidence-dir /home/kaalin/dev/wamn/docs/perf/2026.09/wasmcloud-2-9-cutover/live-receiving-004/journey' > "$wamn_evidence/command.txt"
