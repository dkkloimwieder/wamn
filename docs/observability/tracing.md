...
- **Host-enforced outbound inject.** wash-runtime already *extracts* an incoming
  ...
  see `docs/platform/wash-runtime-fork.md`): it stamps the current W3C trace context onto
...
- S5 logging (the sibling signal + collector/Loki manifests):
  `docs/results/p0-results.md` S5.
- The fork observability init: `docs/platform/wash-runtime-fork.md`.
