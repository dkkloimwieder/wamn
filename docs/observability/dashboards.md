...
`docs/observability/metrics.md` — a renamed or corrupted metric fails the build, not the
...
- The registry (`crates/control/registry`, `deploy/sql/system-schema.sql`) models
  ...
  (`docs/platform/postgres-topology.md`).
...
- The three sinks: `docs/observability/tracing.md` (9.1), `docs/observability/metrics.md` (9.8), S5 logging.
- Registry model: `docs/platform/registry-model.md`, `deploy/sql/system-schema.sql`.
