...
`docs/platform/wash-runtime-fork.md`)*: `scripts/vendor-wasmcloud.sh` cloned the pinned
...
the minimal `wamn:node` contract (docs/contracts/wamn-node.wit) —
...
retained. (docs/execution/wamn-node-design-notes.md note 9b updated.)
