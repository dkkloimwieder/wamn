...
load_mutation() {
  ...
  case "$id" in
    in-flight-recovery-becomes-refusal)
      ...
      EXPECTED_SHA="bbc74123cd611be155fb3871e1ea5bde8cd8355166976d391ec6f5cf1b98c8b3"
    ...
    storage-client-key-restores-not-null)
      ...
      EXPECTED_SHA="aac82669b8c6d962c9fab427edf76cf705191f29f6c8e6c32ed654712f761d48"
